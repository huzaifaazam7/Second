...
export default function Layout({ children }) {
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
      ...
      <span class="ml-3 text-xl">Contentful</span>
    </a>
...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <p class="my-6 text-gray-500 dark:text-gray-400">Absolutely! We have a dedicated kids menu featuring dishes like mini pizzas, chicken tenders, and mac & cheese, perfect for younger diners.
      </p>
      <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6 ">About</Link>
          </li>
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6">Premium</Link>
          </li>
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6 ">Campaigns</Link>
          </li>
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6">Blog</Link>
          </li>
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6">Affiliate Program</Link>
          </li>
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6">FAQs</Link>
          </li>
          <li>
              <Link href="/fifth" class="mr-4 hover:underline md:mr-6">Contact</Link>
          </li>
      </ul>
